                            ...
                            <form action="login" method="post" class="login-form">
                                ...
                                <c:set var="cookie" value="${pageContext.request.cookies}"></c:set>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="UserName" name="user" required="" value="${cookie.cuser.value}">
                                </div>
                                <div class="form-group">
                                    <input type="Password" class="form-control" placeholder="Password" name="pass" required="" value="${cookie.cpass.value}">                           
                                </div>
                                <div>
                                    <input type="checkbox" name="remember" id="rem" value="ON" value="${(cookie.crem != null ? 'check':'')}">
